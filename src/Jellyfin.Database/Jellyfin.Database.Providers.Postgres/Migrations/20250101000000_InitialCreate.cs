...
namespace Jellyfin.Database.Providers.Postgres.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            // PostgreSQL has no min(uuid) or max(uuid) aggregate, but Jellyfin's queries use one to
            // pick a deterministic representative row per group when collapsing alternate versions
            // and series. SQLite's min() is type agnostic, so upstream never needed to think about
            // it. The ordering only has to be stable and total, not meaningful.
            // Guarded, so that a future server shipping these natively is left alone.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortOverview = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    Type = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ItemId = table.Column<string>(type: "text", nullable: true, collation: "C"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Client = table.Column<string>(type: "text", nullable: false, collation: "C"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Username = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    NormalizedUsername = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    Password = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    MustUpdatePassword = table.Column<bool>(type: "boolean", nullable: false),
                    AudioLanguagePreference = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    AuthenticationProviderId = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    PasswordResetProviderId = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    ...
                    SubtitleLanguagePreference = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    ...
                    CastReceiverId = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    RowVersion = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    AccessToken = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    AppName = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    AppVersion = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    DeviceName = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    DeviceId = table.Column<string>(type: "text", nullable: false, collation: "C"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DashboardTheme = table.Column<string>(type: "text", nullable: true, collation: "C"),
                    TvHome = table.Column<string>(type: "text", nullable: true, collation: "C")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortBy = table.Column<string>(type: "text", nullable: false, collation: "C"),
                    SortOrder = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            // that dedup scans and groups the whole table on every request. This mirrors the SQLite
            // migration AddPeopleNameLowerIndex.
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                DROP FUNCTION IF EXISTS public.uuid_smaller(uuid, uuid);
                DROP FUNCTION IF EXISTS public.uuid_larger(uuid, uuid);
                """);
